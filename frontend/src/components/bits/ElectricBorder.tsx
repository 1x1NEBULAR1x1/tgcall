...
const ElectricBorder = ({
  ...
  useEffect(() => {
    ...
    const updateSize = () => {
      ...
      (canvas as HTMLCanvasElement).width = width * dpr;
      (canvas as HTMLCanvasElement).height = height * dpr;
  ...
  return (
    <div ref={containerRef} className={`${styles.root} ${round ? styles.round : ''} ${className ?? ''}`} style={{ ...vars, ...style }}>
